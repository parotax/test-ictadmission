...
declare const useColorScheme: () => import("../../system").ColorSchemeContextValue<SupportedColorScheme>, deprecatedGetInitColorSchemeScript: typeof import("../../system/InitColorSchemeScript").default;
 ...
 */
export declare const CssVarsProvider: (props: import("react").PropsWithChildren<Partial<import("../../system").CssVarsProviderConfig<SupportedColorScheme>> & {
  theme?: {
    $$material: {
  ...
  storageManager?: import("../../system").StorageManager | null | undefined;
