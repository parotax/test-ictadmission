...
import type { SxProps, AllSystemCSSProperties, ResponsiveStyleValue, OverwriteCSSProperties, AliasesCSSProperties } from "@mui/system/styleFunctionSx";
import type { PropsFor } from "@mui/system/style";
import type { ComposedStyleFunction } from "@mui/system/compose";
import type { Theme as SystemTheme } from "@mui/system/createTheme";
import type borders from "@mui/system/borders";
import type display from "@mui/system/display";
import type flexbox from "@mui/system/flexbox";
import type grid from "@mui/system/cssGrid";
import type palette from "@mui/system/palette";
import type positions from "@mui/system/positions";
import type shadows from "@mui/system/shadows";
import type sizing from "@mui/system/sizing";
import type spacing from "@mui/system/spacing";
import type typography from "@mui/system/typography";
